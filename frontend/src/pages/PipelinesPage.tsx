    ...
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} className="space-y-6">
      <section className="rounded-[32px] border border-white/10 bg-[#111827]/80 p-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <button className="rounded-2xl bg-primary/20 px-4 py-2 text-sm font-medium text-white">Create pipeline</button>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ...
            <div key={pipeline.name} className="rounded-[28px] border border-white/10 bg-white/5 p-5 transition hover:bg-white/10">
              ...
              <button className="mt-4 w-full rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-sm font-medium text-white transition hover:bg-white/10">
                View pipeline
              </button>
            </div>
          ))}
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="rounded-[32px] border border-white/10 bg-[#111827]/80 p-6">
          ...
          <div className="space-y-3">
            <button className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-medium text-white transition hover:bg-white/10">
