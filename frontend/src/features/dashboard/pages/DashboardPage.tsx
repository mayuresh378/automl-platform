            ...
            <Card hover className="cursor-pointer" onClick={stat.onClick}>
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-zinc-200 mt-1"><AnimatedCounter to={stat.value} /></p>
                </div>
                <div className={`w-10 h-10 rounded bg-gradient-to-br ${stat.color} flex items-center justify-center`}>
                  {stat.icon}
                </div>
              </div>
            </Card>
